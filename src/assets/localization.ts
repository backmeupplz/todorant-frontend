export const messages = {
  ...
  ru: {
    ...
    home: {
      ...
      pitch:
        'Привет! Меня зовут Никита, и я, похоже, создал лучший менеджер задач на основе знаний, которые я почерпнул из книг <a href="https://google.com">Willpower</a>, <a href="https://google.com">Getting Things Done</a> и <a href="https://google.com">Eat Your Frog</a>. Я разобрался в представленных идеях, упростил их, попробовал на себе и разработал этот вебсайт, основываясь на постулатах ниже. Попробуйте, и ваша продуктивность взлетит до небес — ну или я просто верну вам деньги.',
      ideas: {
