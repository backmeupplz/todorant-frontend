  ...
  en: {
    ...
    howto: {
      ...
      rules: {
        ...
        8: 'You are allowed to skip current task — but only 1 time a day, 3 times a week. You cannot skip a frog. If you failed to complete a task and had to redistribute it twice, it becomes a frog.',
  ...
  ru: {
    ...
    howto: {
      ...
      rules: {
        ...
        8: 'Вам разрешено пропускать текущую задачу — но только 1 раз в день, 3 раза в неделю. Если вы не смогли выполнить задачу и вам пришлось ее перераспределить дважды — она становится лягушкой.',
