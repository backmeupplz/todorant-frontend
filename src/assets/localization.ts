  ...
  ua: {
    ...
    home: {
      texts: {
        ...
        personal: [
          'Що б я зробив?',
          'Я випробував десятки різних менеджерів задач. Якби я міг спробувати Тудурант до того, як я його розробив - то я б точно дав йому шанс. Він безкоштовний перші 30 днів - і цього часу досить, щоб зрозуміти, чи працює ця система для мене. Кажу вам, якщо вона працювала б і я завершував б всі мої завдання - я б заплатив будь-яку ціну, аби продовжити цей потік продуктивності. Перші 30 днів від користувачів нічого не потрібно - лише потрібно увійти та почати користуватися. Можете знайти кнопки нижче. Досить зволікати - прийшов час підривати продуктивність'
        ]
      },
