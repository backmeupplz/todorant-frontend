  ...
  ua: {
    ...
    qr: {
      ...
      description: {
        ...
        web_login:
          'Залогіньтеся у мобільному додатку Тудуранта, зайдіть в налаштування, натисніть на "Додати пристрої" в секції "Аккаунт" і просканируйте цей QR код для того, щоб дозволити ввійти в ваш обликовий запис в браузері. Пам`ятайте : цей QR код працює тільки 10 хвилин!',
      },
    },
    breakdown: {
      request:
    ...
    settings: {
      ...
      duplicateTagInBreakdown: 'Копієвати хештеги при розбивці',
      ...
      removeCompletedFromCalendar:
        'Удаляти задачі з Гугл Календаря після виконання',
    },
    ...
    rank777Description:
      'На цьому ранзі ви будете лише 23 очки. Зробіть так, щоб ви могли пишатися цими очками. Сьогодні ваш щасливий день!',
    rank800Title: 'T-800 🤖',
    rank800Description:
    ...
    rank2048Title: 'Майстер шахмат ♔',
    rank2048Description:
      'Ви віддаєте перевагу продуктивності різним безглуздим іграм, які просто вбивають час, правда? ПРАВДА?',
    ...
    rank12800Description:
      'Ви разбиваєте задачі, ніби розщиплюєте атомы. Продовжуйте бути офігенним!',
    homeShort: {
    ...
    letsGo: 'Поїхали!',
    introText0:
      'Привіт! Це Нікіта, творець Тудуранта. Я так радий, що ви скачали Тудурант — ведь это означает, что и вы скоро разблокируете безграничную продуктивность!',
    introText1:
      'Большинство людей, которые оказываются здесь, похожи на меня: ощущение, как будто попробовали все существующие приложения продуктивности, но ни одно из них не сработало.',
    introText2:
      'Давайте я расскажу вам, почему Тудурант стал моим последним и единственным приложением продуктивности и как ваша жизнь изменится в следующие 3-4 недели. Просто прокручивайте страницу вправо или пользуйтесь кнопками ниже!',
    ...
    breakdownMessage: {
      title: 'Повторююча задача',
      text: 'Це повторююча задача, ви хочете її розбити чи завершити?',
      complete: 'Завершити',
    },
  },  
  it: {
