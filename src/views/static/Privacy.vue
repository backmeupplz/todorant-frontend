<template lang="pug">
.v-container.pa-4
  h2 Privacy Policy of Todorant
  p Todorant operates the todorant.com website, which provides the SERVICE.
  p This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the Todorant website.
  ...
  h3 Accounts
  p To retrieve or delete your account data, please, send the request to accounts@todorant.com.
